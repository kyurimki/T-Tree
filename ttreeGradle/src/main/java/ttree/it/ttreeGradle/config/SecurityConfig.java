...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception{
        httpSecurity.csrf().disable()
                ...
                .antMatchers("/projectPost/edit", "/projectRules", "/projectNotes", "/admin/**", "/changePW", "/changeEmail").hasRole("ADMIN")
                .antMatchers("/user/studentPage", "/changeEmail").hasRole("STUDENT")
                .antMatchers("/download/**", "/projectList", "/changePW", "/projectPost/**").authenticated()
                .and()
